    ...
    private val whatsNew = """
        <div style="$Styles.CONTAINER">
            ...
            <ul style="margin: 0; padding-left: 18px;">
                <li style="$Styles.LIST_ITEM">🎨 Improved identifier under caret background color for better visibility</li>
                <li style="$Styles.LIST_ITEM">✨ Updated selection background to neutral gray for better contrast</li>
            </ul>
        </div>
    """.trimIndent()
